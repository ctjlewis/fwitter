        ...
        <React.Fragment>
          <div className="search-results">
            ...
            <div className="search-results-people">
              {renderUserResults(searchResults.filter((e) => e.alias))}
            </div>
          </div>
          <div className="search-results">
            <div className="search-results-title">Tags</div>
            <div className="search-results-tags">
              {renderTagResults(searchResults.filter((e) => !e.alias))}
            </div>
          </div>
        </React.Fragment>
      );
    ...
    return searchResults.map((res) => {
      ...
      return (
        <div
          ...
          onClick={(event) => handleUserClick(event, res)}
        >
          <div className="avatar">
            <img
              className="avatar-image"
              src={`/images/${res.icon}.png`}
              alt="profile"
            />
          </div>
          ...
          <div
            className="search-result-follow-button"
            onClick={(event) => handleFollowUser(event, res)}
          >
    ...
    return searchResults.map((res) => {
      ...
      return (
        <div
          key={key}
          className="search-result"
          onClick={(event) => handleTagClick(event, res)}
        >
